...
async function main() {
    ...
    const sdk = new CodexSDK({
        ...
        // By default, the SDK will look for 'codex' in PATH
        // Relative to cwd above
        // codexPath: '../node_modules/.bin/codex',
        // Optional config overrides (overrides `~/.codex/config.toml`)
        // config: {
        ...
        //     sandbox_permissions: [SandboxPermission.DISK_FULL_READ_ACCESS, SandboxPermission.DISK_WRITE_CWD],
        // }
    });
    ...
    //     // NOTE: At moment it the only way to set the instructions is to use the configureSession method
    //     instructions: 'You are a helpful coding assistant, your name is "Flexbe Bot". Provide concise and clear responses.',
    //     // NOTE: You can also set the model and custom provider here
    ...
    //     approval_policy: AskForApproval.AUTO_EDIT,
    //     sandbox_policy: { 
